...
function ChatArea() {
  ...
  const manejarEnvio = async (evento) => {
    ...
    try {
      ...
      // La API key ahora vive segura en el backend, el frontend solo llama a /api/chat
        ...
        body: JSON.stringify({
          ...
          messages: [
            // Le damos algo de contexto inicial
            {
              role: "system",
              content:
                "Eres un asistente experto en programación web y React. Responde en español de forma clara y concisa.",
            },
